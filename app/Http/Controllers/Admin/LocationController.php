...
class LocationController extends Controller
{
    ...
    public function __construct(Location $repository, FormBuilder $formBuilder)
    {
        $this->module = 'location';
        $this->route = 'admin.location';
        $this->repository = $repository;
        $this->formBuilder = $formBuilder;
        $this->form = 'App\Forms\LocationForm';
        $this->path = 'arise/location';
