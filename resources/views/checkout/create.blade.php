                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="item-bootcamp">
                            ...
                            <p class="description">
                                Jasa Travel dan Open Trip di Vetours ini sudah terpercaya.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="phone" type="text" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" value="{{Auth::user()->phone}}" required />
                                @if ($errors->has('phone'))
